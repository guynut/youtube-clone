...
export const DummyThumbnailData: VideoData[] = [
    {
        title:'[R(ae)cord] 내 꿈이었는데 히치하이킹🚙 | aespa 에스파 ‘Live My Life’ MV, Universe, Commercial Behind',
    ...
    },
    {
        ...
        chanel:'Guynut',
        chanelLogo:'/public/images/userProfile.jpg',
        videoLink:'nkjBUOYBAV4398gvunisd',
        views:123214,
    },
    {
        title:'[R(ae)cord] 내 꿈이었는데 히치하이킹🚙 | aespa 에스파 ‘Live My Life’ MV, Universe, Commercial Behind',
